		...
		<c:if test="${not empty cart.items }">
							...
							<c:forEach items="${cart.items }" var="item">
								<tr class="active">
									...
									<td width="10%"><input type="text" name="quantity"
										value="1" maxlength="4" size="10" readonly="readonly"></td>
			...
			<div style="margin-right: 130px;">
				...
				<div
					...
					<a href="${pageContext.request.contextPath }/cart?method=clearCart"
						id="clear" class="clear">清空购物车</a>
					<a href="${pageContext.request.contextPath }/order?method=addOrder"> <input
...
<script type="text/javascript">
	function removeFromCart(pid) {
		if (confirm("确认删除?")) {
			location.href = "${pageContext.request.contextPath }/cart?method=removeCart&pid="
					+ pid;
		}
	}
</script>
